    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fadeIn">
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 animate-slideUp">
        ...
        <p className="text-gray-600 text-center mb-2">
          ¿Estás seguro de que deseas eliminar el rol <span className="font-semibold text-gray-900">"{roleName}"</span>?
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            ...
            disabled={isLoading}
            className="flex-1 bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
          >
            {isLoading ? (
              <>
                <svg
